function draw(geo_data) {
    ...
    function plot_points(data) {
        ...
        svg.append('g')
            ...
            .on("click", function(d) { //To edit the information that appears in the top left corner when circles are clicked
                selected_airport = this;
                d3.select("p")
    ...
    function update()
    {
        ...
        if (selected_airport) {
            var selected_airport_data = d3.select(selected_airport).data()[0];
            d3.select("p")
                .html("<b>" + selected_airport_data["airport"]+ "</b> <br> Average minutes of " + toread + " delays per flight: " + selected_airport_data[toread])
        }
    }
